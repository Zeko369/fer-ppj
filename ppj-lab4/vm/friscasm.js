  ...
  var result = {
    ...
    parse: function (input, startRule) {
            ...
            function replaceLabel(element, baseValueForDiff) {
              if (element.type === "label") {
                ...
                if (typeof labelValue !== "undefined") {
                  element.type = "num";
                  element.value =
                    typeof baseValueForDiff === "undefined"
                      ? labelValue
                      : labelValue - baseValueForDiff;
                } else {
            ...
            if (
              ...
              if (typeof o.alusrc2 !== "undefined" && o.alusrc2.type === "num") {
                if (!canNumberBeObtainedBySignedExtendingThe20BitSuffix(o.alusrc2.value)) {
                  var err = new Error(
                    "Number can't be obtained by sign-extending its lower 20 bits."
                  );
      ...
      var canNumberBeObtainedBySignedExtendingThe20BitSuffix = function (number) {
        ...
        if (
          (bits[19] === "0" && bits.slice(20, 32) != "000000000000") ||
      ...
      var generateMachineCode = function (node) {
        if (
          ...
          typeof node.op === "undefined" ||
          typeof node.optype === "undefined" ||
          typeof allops[node.optype] === "undefined" ||
          typeof allops[node.optype][node.op] === "undefined"
        ) {
          throw new Error(
            "Undefined instruction, operation or operation type." + JSON.stringify(node)
          );
        }
        ...
        switch (node.optype) {
          ...
          case "moveop":
            if (
              node.aludest.type === "reg" &&
              (node.alusrc2.type === "reg" || node.alusrc2.type === "num")
            ) {
